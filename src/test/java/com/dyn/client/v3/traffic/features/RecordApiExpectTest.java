...
import com.dyn.client.v3.traffic.parse.GetAAAARecordResponseTest;
import com.dyn.client.v3.traffic.parse.GetARecordResponseTest;
import com.dyn.client.v3.traffic.parse.GetCNAMERecordResponseTest;
import com.dyn.client.v3.traffic.parse.GetMXRecordResponseTest;
import com.dyn.client.v3.traffic.parse.GetNSRecordResponseTest;
import com.dyn.client.v3.traffic.parse.GetPTRRecordResponseTest;
import com.dyn.client.v3.traffic.parse.GetRecordResponseTest;
import com.dyn.client.v3.traffic.parse.GetSOARecordResponseTest;
import com.dyn.client.v3.traffic.parse.GetSPFRecordResponseTest;
import com.dyn.client.v3.traffic.parse.GetSRVRecordResponseTest;
import com.dyn.client.v3.traffic.parse.GetSSHFPRecordResponseTest;
import com.dyn.client.v3.traffic.parse.GetTXTRecordResponseTest;
import com.dyn.client.v3.traffic.parse.ListRecordsResponseTest;

/**
 * @author Adrian Cole
 */
@Test(groups = "unit", testName = "RecordApiExpectTest")
public class RecordApiExpectTest extends BaseDynTrafficApiExpectTest {
   ...
   public void testGetWhenResponseIs2xx() {
      DynTrafficApi success = requestsSendResponses(createSession, createSessionResponse, getSOA, soaResponse);
   ...
   public void testGetWhenResponseIs404() {
      DynTrafficApi fail = requestsSendResponses(createSession, createSessionResponse, getSOA, notFound);
   ...
   public void testGetAAAAWhenResponseIs2xx() {
      DynTrafficApi success = requestsSendResponses(createSession, createSessionResponse, getAAAA, aaaaResponse);
   ...
   public void testGetAAAAWhenResponseIs404() {
      DynTrafficApi fail = requestsSendResponses(createSession, createSessionResponse, getAAAA, notFound);
   ...
   public void testGetAWhenResponseIs2xx() {
      DynTrafficApi success = requestsSendResponses(createSession, createSessionResponse, getA, aResponse);
   ...
   public void testGetCNAMEWhenResponseIs404() {
      DynTrafficApi fail = requestsSendResponses(createSession, createSessionResponse, getCNAME, notFound);
   ...
   public void testGetMXWhenResponseIs2xx() {
      DynTrafficApi success = requestsSendResponses(createSession, createSessionResponse, getMX, mxResponse);
   ...
   public void testGetMXWhenResponseIs404() {
      DynTrafficApi fail = requestsSendResponses(createSession, createSessionResponse, getMX, notFound);
   ...
   public void testGetNSWhenResponseIs404() {
      DynTrafficApi fail = requestsSendResponses(createSession, createSessionResponse, getNS, notFound);
   ...
   public void testGetPTRWhenResponseIs404() {
      DynTrafficApi fail = requestsSendResponses(createSession, createSessionResponse, getPTR, notFound);
   ...
   public void testGetSPFWhenResponseIs2xx() {
      DynTrafficApi success = requestsSendResponses(createSession, createSessionResponse, getSPF, spfResponse);
   ...
   public void testGetSRVWhenResponseIs2xx() {
      DynTrafficApi success = requestsSendResponses(createSession, createSessionResponse, getSRV, srvResponse);
   ...
   public void testGetSSHFPWhenResponseIs2xx() {
      DynTrafficApi success = requestsSendResponses(createSession, createSessionResponse, getSSHFP, sshfpResponse);
   ...
   public void testGetTXTWhenResponseIs404() {
      DynTrafficApi fail = requestsSendResponses(createSession, createSessionResponse, getTXT, notFound);
   ...
   public void testListByFQDNWhenResponseIs2xx() {
      DynTrafficApi success = requestsSendResponses(createSession, createSessionResponse, listByFQDN, listResponse);
   ...
   public void testListByFQDNWhenResponseIs404() {
      DynTrafficApi fail = requestsSendResponses(createSession, createSessionResponse, listByFQDN, notFound);
   ...
   public void testListByFQDNAndTypeWhenResponseIs404() {
       DynTrafficApi fail = requestsSendResponses(createSession, createSessionResponse, listByFQDNAndType, notFound);
