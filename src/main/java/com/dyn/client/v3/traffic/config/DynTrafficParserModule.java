...
import com.dyn.client.v3.traffic.domain.GeoService;
import com.dyn.client.v3.traffic.domain.Node;
import com.dyn.client.v3.traffic.domain.RecordSet;
import com.dyn.client.v3.traffic.domain.SessionCredentials;
import com.dyn.client.v3.traffic.domain.RecordSet.Value;
import com.dyn.client.v3.traffic.domain.RecordSet.Value.Builder;
 ...
 * @author Adrian Cole
 */
public class DynTrafficParserModule extends AbstractModule {
