...
import static com.dyn.client.v3.traffic.domain.Zone.SerialStyle.INCREMENT;
import static com.dyn.client.v3.traffic.domain.Zone.Type.PRIMARY;
 ...
 */
@Test(groups = "unit")
public class GetZoneResponseTest extends BaseDynTrafficParseTest<Zone> {
