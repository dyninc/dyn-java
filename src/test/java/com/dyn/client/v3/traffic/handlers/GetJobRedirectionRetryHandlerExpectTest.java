...
public class GetJobRedirectionRetryHandlerExpectTest extends BaseDynTrafficApiExpectTest {
   ...
   public void testRedirectOnJobLocationSwitchesToGETAndNoPayload() {
      ...
      DynTrafficApi apiThatRedirects = requestsSendResponses(createSession, createSessionResponse, thaw, redirectResponse,
            job, success);
