...
import static com.dyn.client.v3.traffic.domain.rdata.CNAMEData.cname;
 ...
 */
@Test(groups = "unit")
public class GetCNAMERecordResponseTest extends BaseDynTrafficParseTest<Record<CNAMEData>> {
