...
/**
 * Dyn Messaging Complaint Report API
 */
@RequestFilters({ AlwaysAddUserAgent.class, AlwaysAddApiKey.class })
public interface ComplaintsReportApi extends ReportApi {
	@Named("GetComplaintsCount")
	@GET
	...
	@Named("GetComplaintsList")
	@GET
	@Path("/reports/complaints")
	@SelectJson("complaints")
	@Consumes(APPLICATION_JSON)
	@Override
